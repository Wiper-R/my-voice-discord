...
class MyHelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        **Commands - {count}**
        ...
        """
        embed = discord.Embed(
            title="Hi there!", description=description, colour=get_colour())
        embed.set_footer(text=f'Requested by {self.context.author}', icon_url=str(
            self.context.author.avatar_url))
